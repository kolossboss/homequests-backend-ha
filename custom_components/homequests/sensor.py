...
CHILD_SENSORS: tuple[HomeQuestsSensorDescription, ...] = (
    ...
    HomeQuestsSensorDescription(
        ...
        value_fn=lambda child: child["points_balance"],
        unit="Punkte",
        attributes_fn=lambda child: {
            "lifetime_earned_points": child["lifetime_earned_points"],
            "lifetime_spent_points": child["lifetime_spent_points"],
            "average_points_per_day": child["average_points_per_day"],
            "average_points_per_week": child["average_points_per_week"],
            "average_points_per_month": child["average_points_per_month"],
            "reward_request_stats": child["reward_request_stats"],
            "reward_spent_stats": child["reward_spent_stats"],
            "status_distribution": child["status_distribution"],
        },
    ),
    HomeQuestsSensorDescription(key="lifetime_earned_points", name="Punkte jemals gesammelt", icon="mdi:star-plus-outline", value_fn=lambda child: child["lifetime_earned_points"], unit="Punkte"),
    HomeQuestsSensorDescription(key="lifetime_spent_points", name="Punkte ausgegeben", icon="mdi:star-minus-outline", value_fn=lambda child: child["lifetime_spent_points"], unit="Punkte"),
